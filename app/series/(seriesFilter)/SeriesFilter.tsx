...
const SeriesFilter = ({ movies }: MoviesFilterProps) => {
  ...
  useEffect(() => {
    if (selectedGenre === "") {
      setFilteredMovies(movies.filter((movie) => movie.Series === true));
    } else {
      const filtered = movies.filter(
        (movie) => movie.Genre.includes(selectedGenre) && movie.Series === true
      );
